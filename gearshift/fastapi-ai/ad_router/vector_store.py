...
# # DATA_PATH = os.path.join(os.path.dirname(__file__), "/ad_router/car_data.csv")  # 절대경로 기반 처리

# ad_router/vector_store.py
import os
BASE_DIR = os.path.dirname(__file__)          # ad_router 절대경로
